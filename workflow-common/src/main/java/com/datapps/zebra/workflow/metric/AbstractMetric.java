...
package com.datapps.zebra.workflow.metric;
...
public abstract class AbstractMetric<T> implements IMetric<T>, Cloneable {
   ...
   * {@inheritDoc}
   *
   * @see com.datapps.zebra.workflow.metric.IMetric#getName()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see com.datapps.zebra.workflow.metric.IMetric#getValueType()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see com.datapps.zebra.workflow.metric.IMetric#updateMetricManager(com.datapps.zebra.workflow.metric.MetricReportManager)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see com.datapps.zebra.workflow.metric.IMetric#getSnapshot()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see com.datapps.zebra.workflow.metric.IMetric#getValue()
   */
  @Override
  public T getValue() {
    return this.value;
   ...
   * {@inheritDoc}
   *
   * @see com.datapps.zebra.workflow.metric.IMetric#notifyManager()
   */
  @Override
