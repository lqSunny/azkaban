...
import com.datapps.zebra.workflow.database.AbstractJdbcLoader;
import com.datapps.zebra.workflow.executor.ExecutorLogEvent.EventType;
import com.datapps.zebra.workflow.metrics.CommonMetrics;
import com.datapps.zebra.workflow.utils.*;
...
public class JdbcExecutorLoader extends AbstractJdbcLoader implements
   ...
   *
   * {@inheritDoc}
   * @see com.datapps.zebra.workflow.executor.ExecutorLoader#fetchQueuedFlows()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see com.datapps.zebra.workflow.executor.ExecutorLoader#fetchActiveExecutors()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see com.datapps.zebra.workflow.executor.ExecutorLoader#fetchExecutor(String, int)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see com.datapps.zebra.workflow.executor.ExecutorLoader#fetchExecutor(int)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see com.datapps.zebra.workflow.executor.ExecutorLoader#updateExecutor(int)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see com.datapps.zebra.workflow.executor.ExecutorLoader#addExecutor(String, int)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see com.datapps.zebra.workflow.executor.ExecutorLoader#removeExecutor(String, int)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see com.datapps.zebra.workflow.executor.ExecutorLoader#postExecutorEvent(com.datapps.zebra.workflow.executor.Executor,
   *      com.datapps.zebra.workflow.executor.ExecutorLogEvent.EventType, String,
   *      String)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see com.datapps.zebra.workflow.executor.ExecutorLoader#getExecutorEvents(com.datapps.zebra.workflow.executor.Executor,
   *      int, int)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see com.datapps.zebra.workflow.executor.ExecutorLoader#assignExecutor(int, int)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see com.datapps.zebra.workflow.executor.ExecutorLoader#fetchExecutorByExecutionId(int)
   */
  @Override
   ...
   *
   * {@inheritDoc}
   * @see com.datapps.zebra.workflow.executor.ExecutorLoader#unassignExecutor(int)
   */
  @Override
