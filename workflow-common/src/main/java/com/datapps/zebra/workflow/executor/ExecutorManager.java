...
import com.datapps.zebra.workflow.event.EventHandler;
import com.datapps.zebra.workflow.executor.selector.ExecutorComparator;
import com.datapps.zebra.workflow.executor.selector.ExecutorFilter;
import com.datapps.zebra.workflow.executor.selector.ExecutorSelector;
import com.datapps.zebra.workflow.metrics.CommonMetrics;
import com.datapps.zebra.workflow.project.Project;
import com.datapps.zebra.workflow.project.ProjectWhitelist;
import com.datapps.zebra.workflow.utils.FileIOUtils.JobMetaData;
import com.datapps.zebra.workflow.utils.FileIOUtils.LogData;
import com.datapps.zebra.workflow.utils.FlowUtils;
import com.datapps.zebra.workflow.utils.JSONUtils;
import com.datapps.zebra.workflow.utils.Pair;
...
public class ExecutorManager extends EventHandler implements
   ...
   *
   * {@inheritDoc}
   * @see com.datapps.zebra.workflow.executor.ExecutorManagerAdapter#setupExecutors()
   */
  @Override
   ...
   * {@inheritDoc}
   * @see com.datapps.zebra.workflow.executor.ExecutorManagerAdapter#disableQueueProcessorThread()
   */
  @Override
   ...
   * Throws exception if running in local mode
   * {@inheritDoc}
   * @see com.datapps.zebra.workflow.executor.ExecutorManagerAdapter#enableQueueProcessorThread()
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see com.datapps.zebra.workflow.executor.ExecutorManagerAdapter#fetchExecutor(int)
   */
  @Override
   ...
   *
   * @see com.datapps.zebra.workflow.executor.ExecutorManagerAdapter#getRunningFlows(int,
   *      String)
   */
  @Override
   ...
   *
   * @see com.datapps.zebra.workflow.executor.ExecutorManagerAdapter#isFlowRunning(int,
   *      String)
   */
  @Override
   ...
   *
   * @see com.datapps.zebra.workflow.executor.ExecutorManagerAdapter#getExecutableFlow(int)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see com.datapps.zebra.workflow.executor.ExecutorManagerAdapter#getRunningFlows()
   */
  @Override
   ...
   *
   * @see com.datapps.zebra.workflow.executor.ExecutorManagerAdapter#cancelFlow(com.datapps.zebra.workflow.executor.ExecutableFlow,
   *      String)
   */
  @Override
   ...
   * @throws ExecutorManagerException
   *
   * @see com.datapps.zebra.workflow.executor.ExecutorManagerAdapter#callExecutorStats(String,
   *      com.datapps.zebra.workflow.utils.Pair[])
   */
  @Override
