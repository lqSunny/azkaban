...
public interface ExecutorManagerAdapter {
   ...
   * <ul>
   * <li>{@link com.datapps.zebra.workflow.executor.ConnectorParams#STATS_SET_REPORTINGINTERVAL}<li>
   * <li>{@link com.datapps.zebra.workflow.executor.ConnectorParams#STATS_SET_CLEANINGINTERVAL}<li>
   * <li>{@link com.datapps.zebra.workflow.executor.ConnectorParams#STATS_SET_MAXREPORTERPOINTS}<li>
   * <li>{@link com.datapps.zebra.workflow.executor.ConnectorParams#STATS_GET_ALLMETRICSNAME}<li>
   * <li>{@link com.datapps.zebra.workflow.executor.ConnectorParams#STATS_GET_METRICHISTORY}<li>
   * <li>{@link com.datapps.zebra.workflow.executor.ConnectorParams#STATS_SET_ENABLEMETRICS}<li>
   * <li>{@link com.datapps.zebra.workflow.executor.ConnectorParams#STATS_SET_DISABLEMETRICS}<li>
   * </ul>
   */
