...
import com.datapps.zebra.workflow.flow.Edge;
import com.datapps.zebra.workflow.flow.Flow;
import com.datapps.zebra.workflow.flow.FlowProps;
import com.datapps.zebra.workflow.flow.Node;
import com.datapps.zebra.workflow.project.*;
import com.datapps.zebra.workflow.project.validator.ValidationReport;
import com.datapps.zebra.workflow.project.validator.ValidatorConfigs;
import com.datapps.zebra.workflow.scheduler.Schedule;
import com.datapps.zebra.workflow.scheduler.ScheduleManager;
import com.datapps.zebra.workflow.scheduler.ScheduleManagerException;
import com.datapps.zebra.workflow.server.session.Session;
import com.datapps.zebra.workflow.user.*;
import com.datapps.zebra.workflow.user.Permission.Type;
...
public class ProjectManagerServlet extends LoginAbstractAzkabanServlet {
  ...
  protected void handleGet(final HttpServletRequest req, final HttpServletResponse resp,
    ...
    final Page page =
        newPage(req, resp, session,
                "com/datapps/zebra/workflow/webapp/servlet/velocity/projectpage.vm");
  ...
  private void handleProjectLogsPage(final HttpServletRequest req,
    ...
    final Page page =
        newPage(req, resp, session,
                "com/datapps/zebra/workflow/webapp/servlet/velocity/projectlogpage.vm");
    final String projectName = getParam(req, "project");
  ...
  private void handleJobHistoryPage(final HttpServletRequest req,
    ...
    final Page page =
        newPage(req, resp, session,
                "com/datapps/zebra/workflow/webapp/servlet/velocity/jobhistorypage.vm");
    final String projectName = getParam(req, "project");
    final User user = session.getUser();
  ...
  private void handlePermissionPage(final HttpServletRequest req,
    ...
    final Page page =
        newPage(req, resp, session,
                "com/datapps/zebra/workflow/webapp/servlet/velocity/permissionspage.vm");
    final String projectName = getParam(req, "project");
    final User user = session.getUser();
    PageUtils
        .hideUploadButtonWhenNeeded(page, session, this.userManager, this.lockdownUploadProjects);
  ...
  private void handleJobPage(final HttpServletRequest req, final HttpServletResponse resp,
    ...
    final Page page =
        newPage(req, resp, session,
                "com/datapps/zebra/workflow/webapp/servlet/velocity/jobpage.vm");
    final String projectName = getParam(req, "project");
    final String flowName = getParam(req, "flow");
  ...
  private void handlePropertyPage(final HttpServletRequest req,
    ...
    final Page page =
        newPage(req, resp, session,
                "com/datapps/zebra/workflow/webapp/servlet/velocity/propertypage.vm");
    final String projectName = getParam(req, "project");
    final String flowName = getParam(req, "flow");
    final String jobName = getParam(req, "job");
  ...
  private void handleFlowPage(final HttpServletRequest req, final HttpServletResponse resp,
    ...
    final Page page =
        newPage(req, resp, session,
                "com/datapps/zebra/workflow/webapp/servlet/velocity/flowpage.vm");
    final String projectName = getParam(req, "project");
    final String flowName = getParam(req, "flow");
