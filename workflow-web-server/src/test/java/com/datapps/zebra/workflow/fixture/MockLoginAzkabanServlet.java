...
package com.datapps.zebra.workflow.fixture;
...
import com.datapps.zebra.workflow.webapp.servlet.LoginAbstractAzkabanServlet;
...
public class MockLoginAzkabanServlet extends LoginAbstractAzkabanServlet {
  ...
  public static MockLoginAzkabanServlet getServletWithSession(final String sessionId,
    ...
    final com.datapps.zebra.workflow.user.User user = mock(com.datapps.zebra.workflow.user.User.class);
