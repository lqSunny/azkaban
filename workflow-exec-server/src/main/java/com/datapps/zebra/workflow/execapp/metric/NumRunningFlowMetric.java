...
import com.datapps.zebra.workflow.execapp.FlowRunnerManager;
...
/**
 * Metric to keep track of number of running flows in com.datapps.zebra.workflow exec server
 */
public class NumRunningFlowMetric extends TimeBasedReportingMetric<Integer> {
   ...
   * {@inheritDoc}
   *
   * @see com.datapps.zebra.workflow.metric.TimeBasedReportingMetric#preTrackingEventMethod()
   */
  @Override
